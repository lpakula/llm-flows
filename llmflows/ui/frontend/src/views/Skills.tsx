    ...
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-12 px-4" onClick={onClose}>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          <AuditPanel
            audit={audit}
            onRunAudit={() => api.runSkillAudit(spaceId, skill.name)}
...
function SkillCard({ skill, onClick }: { skill: SkillInfo; onClick: () => void }) {
  return (
    <button
      onClick={onClick}
      className="bg-gray-900 border border-gray-800 rounded-xl p-4 text-left hover:bg-gray-800/50 hover:border-gray-700 transition w-full flex flex-col justify-start items-stretch"
    >
      <div className="flex items-center gap-2">
